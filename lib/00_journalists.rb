...
def handles_quantity
  puts "\n\e[32mIl y a \e[30m\e[42m\e[1m#{TWITTER_HANDLES.length}\e[0m\e[32m handles dans l'array\e[0m\n"
  return_to_menu
end

def shortest_handle
  shortest_element = TWITTER_HANDLES.min_by { |element| element.length }
  puts "\n\e[32mHandle le plus court : \e[30m\e[42m\e[1m#{shortest_element}\e[0m\n"
  return_to_menu
end
...
def handles_by_az
  sorted_handles = TWITTER_HANDLES.sort_by { |element| element[1].downcase}
  puts "\e[1m\e[42m\e[30m#{sorted_handles.join("\n")}\e[0m\n"
  return_to_menu
end
...
def epenser_position
  ...
  puts "\n\e[32m@epenser est à la position \e[1m\e[42m\e[30m#{index}\e[0m\e[32m dans l'array\e[0m\n"
  return_to_menu
end
